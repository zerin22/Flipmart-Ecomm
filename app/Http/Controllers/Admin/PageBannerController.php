...
class PageBannerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.singlePageBanner.indexSinglePageBanner', compact('banners'));
    }
    ...
    {
        return view('admin.singlePageBanner.createSinglePageBanner');
    }
    ...
    public function store(Request $request)
    {
        ...
        $bannerImage = new PageBanner;
        $bannerImage->image = $final_image ;
        $bannerImage->save();

        return redirect()->route('singlePageBanner.index')->with('success', 'Image added successfully');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.singlePageBanner.editSinglePageBanner', compact('banners'));
    }
    ...
    public function update(Request $request, $id)
    {
        if($request->file('image'))
        {
            ...
            $banners->save();
            return redirect()->route('singlePageBanner.index')->with('success', 'Image update successfully');
