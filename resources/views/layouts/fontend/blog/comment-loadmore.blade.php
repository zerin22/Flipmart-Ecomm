@foreach ($blogcomments as $blogcomment)
    <div class="col-md-2 col-sm-2">
        <img src="{{ asset($blogcomment->relationWithUser->image) ?? asset('backend/images/default/profile_img.png') }}" alt="Responsive image" class="img-rounded img-responsive">
    </div>
    <div class="col-md-10 col-sm-10 blog-comments outer-bottom-xs">
        ...
        <div class="blog-comments-responce outer-top-xs ">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-2">
                    <img src="{{ asset($reply->relationWithUser->image) ?? asset('backend/images/default/profile_img.png') }}" class="img-rounded img-responsive">
                </div>
